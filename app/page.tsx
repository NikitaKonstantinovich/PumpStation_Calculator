...
function Specification({ entity, settings, catalogue }: { entity: SpecEntity; settings: SettingsEntity; catalogue:Pump[] }) {
  ...
  const optionVisible=(option:SpecOption|undefined)=>!option||option==="secondaryPump"||option==="primarySuctionValve"||option==="primaryDischargeValve"||option==="primaryCheckValve"||option==="secondarySuctionValve"||option==="secondaryDischargeValve"||option==="secondaryCheckValve"||(option==="membraneTank"?settings.membraneTank:option==="vibrationCompensators"?settings.vibrationCompensators:option==="collectorPlugs"?settings.collectorPlugs:settings.isolatingValves);
...
function FloatingPanel({ panel, zoom, layoutMode="free", entity, input, secondaryInput, settings, draftPoint, catalogue, onDraftPointChange, onInputChange, onSettingsChange, onDnChange, onAddValves, onAddToSpec, onCabinetConfigured, onFocus, onChange, onDetach, onMinimize, onClose, secondaryEnabled }: { panel: PanelState; zoom: number; layoutMode?:WorkspaceMode; entity?: ProjectEntity; input: InputEntity; secondaryInput:InputEntity; settings: SettingsEntity; draftPoint:{flowRate:string;head:string}; catalogue:Pump[]; onDraftPointChange:(point:{flowRate:string;head:string})=>void; onInputChange: (patch: Partial<InputEntity>) => void; onSettingsChange:(patch:Partial<SettingsEntity>)=>void; onDnChange:(patch:Partial<DnEntity>)=>void; onAddValves:()=>void; onAddToSpec:()=>void; onCabinetConfigured:(cabinet:SmartCabinet)=>void; onFocus: () => void; onChange: (p: PanelState) => void; onDetach: () => void; onMinimize:()=>void; onClose:()=>void; secondaryEnabled:boolean }) {
